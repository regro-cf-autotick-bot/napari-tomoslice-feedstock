...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-tomoslice-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15251&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-tomoslice-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-tomoslice` can be installed with:

```
conda install napari-tomoslice
```

It is possible to list all of the versions of `napari-tomoslice` available on your platform with:
